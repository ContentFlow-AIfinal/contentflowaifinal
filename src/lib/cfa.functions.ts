...
const brandSchema = z.object({
  ...
  banned_words: z.string().nullable().optional(),
  preferred_words: z.string().nullable().optional(),
  content_pillars: z.string().nullable().optional(),
  platforms: z.string().nullable().optional(),
  sample_copy: z.string().nullable().optional(),
  language_pref: z.string().nullable().optional(),
  formality: z.string().nullable().optional(),
  emoji_policy: z.string().nullable().optional(),
